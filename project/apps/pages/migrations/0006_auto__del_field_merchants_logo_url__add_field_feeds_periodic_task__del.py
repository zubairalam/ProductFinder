...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Merchants.logo_url'
        db.delete_column(u'pages_merchants', 'logo_url')

        # Adding field 'Feeds.periodic_task'
        db.add_column(u'pages_feeds', 'periodic_task',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djcelery.PeriodicTask'], null=True),
                      keep_default=False)

        # Deleting field 'Providers.logo_url'
        db.delete_column(u'pages_providers', 'logo_url')


    def backwards(self, orm):
        # Adding field 'Merchants.logo_url'
        db.add_column(u'pages_merchants', 'logo_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500),
                      keep_default=False)

        # Deleting field 'Feeds.periodic_task'
        db.delete_column(u'pages_feeds', 'periodic_task_id')

        # Adding field 'Providers.logo_url'
        db.add_column(u'pages_providers', 'logo_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=500),
                      keep_default=False)
